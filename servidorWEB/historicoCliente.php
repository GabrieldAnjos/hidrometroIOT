...
<?php 
//Inicia o Cliente
if(isset($_GET['id_cliente'])) $_SESSION['id_cliente'] = $_GET['id_cliente'];  
$id_cliente=$_SESSION['id_cliente'];
?>

<div class=row>
  <div class = "col s12 m6 push-m3">
    <h3 class="light">Histórico Cliente</h3>
    <br>
    <h4 class="light">Filtrar por Data:</h3>
    <form method="post" action="historicoCliente.php">
    ...
    <table class="striped">
        ...
        <tbody>
            ...
            if(isset($_POST['btn_filtrar'])):
                ...
                $sql= "SELECT  c.nome, SUM(l.consumoPulso) AS consumoTotal , ROUND(SUM(l.consumoPulso)*t.preco, 2) AS consumoTotalReais  FROM leituras l
    ...
    <table class="striped">
        ...
        <tbody>
            ...
            $sql= "SELECT l.dataHora, l.consumoPulso , ROUND((l.consumoPulso*t.preco), 2) AS consumoReais  FROM leituras l
                    INNER JOIN clientes c
                    ON c.id_hidrometro = l.id_hidrometro
                    INNER JOIN tarifas t
                    ON t.id_tarifa = c.id_tarifa
    ...
    <a href="listarClientes.php" class="btn green">Voltar</a>
  </div>
</div>
